...
<body>
 ...
 <div class="header-container fixed-top">
        <header class="new-header header navbar navbar-expand-sm">
             ...
             @if(auth()->check())
                        <ul class="navbar-nav header-right ml-auto align-items-center">
                            ...
                            <li class="nav-item dropdown header-profile mr-3">
                                <a class="nav-link btn btn-primary" href="#" role="button" data-toggle="dropdown">
