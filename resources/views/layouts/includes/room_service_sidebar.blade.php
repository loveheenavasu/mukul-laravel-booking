<ul class="metismenu sidebar-height" id="menu">
    ...
    <li data-toggle="collapse" data-target="#service" class="collapsed" id ="show_service" >
       <a href=""><i class="fa fa-cutlery fa-lg"></i>{{trans('layout.room_items')}} <span class="arrow"></span></a>
    </li>
        <ul>
            @foreach($room_categories as $cat)

                <li><a data-id="{{$cat->id}}" class="ai-icon roomitem-category" href="javascript:void(0)" aria-expanded="false">
