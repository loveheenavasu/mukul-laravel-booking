                        ...
                        <div class="row page-titles mx-0">
                            <div class="col-sm-6 p-md-0 p-0">
                                <div class="card-body cat-title">
                                    <h3 class="text-capitalize" id="category-name-{{ strtolower($categoryName) }}"><span>{{$categoryName}}</span></h3>
                                </div>
                            </div>
                                                    ...
                                                    <div class="price-box d-flex justify-content-end align-items-center">
                                                        ...
                                                        <div class="text-right">
                                                            ...
                                                            <div class="img-btn" id="img-item-{{$item->id}}">
                                                                ...
                                                                @endif
                                                                <button data-value="{{json_encode($item->only(['name','id','price','details','discount','discount_type','discount_to']))}}" data-itemId="{{$item->id}}" class="btn btn-xxs btn-info cart-addon">{{trans('layout.add')}}
                                                                </button>
                                                            </div>
