            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="pull-right">
                        <a href="{{route('roomitems.create')}}" class="btn btn-sm btn-primary">{{trans('layout.create')}}</a>
                    </div>
                </div>
                <div class="card-body">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                   href="{{route('roomitems.edit',[$item])}}">{{trans('layout.edit')}}</a>
                                                <button class="dropdown-item" type="button"
                                                        data-message="{{trans('layout.message.item_delete_warning')}}"
                                                        data-action='{{route('roomitems.destroy',[$item])}}'
