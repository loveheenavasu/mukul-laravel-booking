 ...
 -->
    ...
    <div class="container-fluid">
            <div class="card-deck room_card row justify-content-around">
                <div class="card col-7 room_card_content p-0">
                    <div class="card-body d-flex justify-content-center align-items-center">
                        <i class="fa fa-user fa-3x"></i>
                        <h5 class="card-title ml-3 call-room pb-3 mb-0">Call Room Service</h5>
                    </div>
                </div>
                <div class="card col-3 room_card_content p-0">
        ...
        <div class="category-item-wrapper catg-list" id="category-item-wrapper-{{$categoryItems[0]->category_id}}">
            <div class="row page-titles mx-0">
     ...
     <div class="add-overview col-sm-11" id="add-overview">
        <form action="{{route('order.place')}}" method="post" id="orderForm">
            ...
            <input type="hidden" name="category_type" value="room">
